...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerPrefix(token.LBRACKET, p.parseArrayLitaral)
...
func (p *Parser) parseArrayLitaral() ast.Expression {
...
func (p *Parser) parseIdexExpression(left ast.Expression) ast.Expression {
	exp := &ast.IndexExprssion{Token: p.curToken, Left: left}
