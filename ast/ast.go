...
type IndexExprssion struct {
	Token token.Token
	Left  Expression
	Index Expression
}

func (ie *IndexExprssion) expressionNode()      {}
func (ie *IndexExprssion) TokenLiteral() string { return ie.Token.Literal }
func (ie *IndexExprssion) String() string {
	var out bytes.Buffer
